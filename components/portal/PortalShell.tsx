...
const NAV: Record<PortalRole, NavItemDef[]> = {
  ...
  teacher: [
    ...
    { label: 'Журнал', href: '/teacher/grades', Icon: ClipboardList },
    { label: 'Расписание', href: '/teacher/timetable', Icon: Calendar },
    { label: 'Уведомления', href: '/teacher/notifications', Icon: Bell },
    { label: 'Профиль', href: '/teacher/profile', Icon: User },
  ],
  parent: [
    { label: 'Главная', href: '/parent', Icon: LayoutDashboard },
    { label: 'Расписание', href: '/parent/timetable', Icon: Calendar },
    { label: 'Связаться', href: '/parent/contact', Icon: MessageCircle },
    { label: 'Уведомления', href: '/parent/notifications', Icon: Bell },
  ],
  admin: [
    { label: 'Главная', href: '/admin', Icon: LayoutDashboard },
    { label: 'Статистика', href: '/admin/stats', Icon: BarChart2 },
