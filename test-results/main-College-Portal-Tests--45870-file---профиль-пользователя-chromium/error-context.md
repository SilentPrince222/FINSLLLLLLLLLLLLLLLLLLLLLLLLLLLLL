...
- Name: main.spec.ts >> College Portal Tests >> Test 8: Profile - профиль пользователя
- Location: tests\main.spec.ts:57:7
...
Call log:
  - navigating to "http://localhost:3001/dashboard/profile", waiting until "load"
