...
- Name: main.spec.ts >> College Portal Tests >> Test 5: Teachers - страница преподавателей
- Location: tests\main.spec.ts:38:7
...
Call log:
  - navigating to "http://localhost:3001/dashboard/teachers", waiting until "load"
