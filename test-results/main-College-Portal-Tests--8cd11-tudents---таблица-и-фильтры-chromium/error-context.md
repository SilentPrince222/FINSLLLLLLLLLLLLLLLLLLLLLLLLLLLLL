...
- Name: main.spec.ts >> College Portal Tests >> Test 3: Students - таблица и фильтры
- Location: tests\main.spec.ts:21:7
...
Call log:
  - navigating to "http://localhost:3001/dashboard/students", waiting until "load"
