...
- Name: main.spec.ts >> College Portal Tests >> Test 9: Навигация - переход между страницами
- Location: tests\main.spec.ts:63:7
...
Call log:
  - waiting for locator('aside').getByText('Students')
