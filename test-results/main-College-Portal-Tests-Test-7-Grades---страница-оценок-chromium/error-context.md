...
- Name: main.spec.ts >> College Portal Tests >> Test 7: Grades - страница оценок
- Location: tests\main.spec.ts:51:7
...
Call log:
  - navigating to "http://localhost:3001/dashboard/grades", waiting until "load"
